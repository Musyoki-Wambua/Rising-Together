      ...
      return (
        <div>
          <button class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md">
            <img
              className="h-8"
              src="https://img.icons8.com/?size=512&id=102315&format=png"
              alt="ss"
            />
            Delete
          </button>
      ...
      return (
        <button>
          <div class="relative" onClick={handleUpdateInfo}>
            <img
              className="h-8 ml-7 bg-green-500 rounded-full f  p-1    "
              src="https://img.icons8.com/?size=512&id=r4ZoJ0KDic77&format=png"
              alt="ee"
            />
          </div>
        </button>
  ...
  Your browser does not support the video tag.
              ...
              <div className="mr-44">
                <h1 className="text-3xl flex font-serif font-bold italic">
                  ...
                  Who We Are and How We Define Ourselves <Editename />
                </h1>
                ...
                <div className="w-full h-full mt-9 "> {/* <Review /> */}</div>
              </div>
            </div>
          </div>
        </div>
