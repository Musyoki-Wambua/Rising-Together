...
function ChatBox() {
  ...
  function handleMessage(event) {
    ...
    setConversation([...conversation, { text: message, sender: 'user' }, { text: response, sender: 'bot' }]);
...
<div class="m-3">
   <button onClick={handleButtonClick} id="telegram" class="bg-white  transform hover:-translate-y-3  border-2 w-12 h-12 rounded-full duration-500 text-green-400 border-green-400 hover:bg-green-400 hover:text-white text-2xl">
